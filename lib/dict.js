...
export const DICT = {
  nav: {
    ...
    services:    L('Услуги',       'Pakalpojumi',  'Services'),
    ...
    account:     L('Личный кабинет','Mans konts',  'My account'),
    login:       L('Войти',         'Pieslēgties', 'Sign in'),
  },
  hero: {
  ...
  footer: {
    ...
    legal:      L('Документы',       'Dokumenti',          'Legal'),
    terms:      L('Условия',         'Noteikumi',          'Terms'),
    privacy:    L('Конфиденциальность','Privātuma politika','Privacy'),
    refund:     L('Отмена и возврат','Atcelšana un atmaksa','Cancellation & Refund'),
  ...
  booking: {
    ...
    consentLabel: L(
      'Я ознакомился(-ась) и согласен(-на) с {terms}, {privacy} и {refund}.',
      'Esmu iepazinies(-usies) un piekrītu {terms}, {privacy} un {refund}.',
      'I have read and agree to the {terms}, {privacy} and {refund}.'
    ),
    consentTerms:   L('Условиями','Noteikumiem','Terms'),
    consentPrivacy: L('Политикой конфиденциальности','Privātuma politiku','Privacy Policy'),
    consentRefund:  L('Условиями отмены','Atcelšanas noteikumiem','Cancellation Policy'),
    consentRequired: L('Подтвердите согласие с условиями.','Lūdzu, apstipriniet piekrišanu noteikumiem.','Please confirm consent to the terms.'),
    ...
    successPayText: L(
      'Заявка получена. Чтобы подтвердить бронь окончательно, оплати карты — это займёт 30 секунд.',
      'Pieteikums saņemts. Lai apstiprinātu rezervāciju galīgi, samaksā ar karti — tas aizņem 30 sekundes.',
      "Got it. To finalize the booking, pay by card — it takes 30 seconds."
    ),
    payNow:      L('Оплатить картой', 'Maksāt ar karti',    'Pay by card'),
    payLater:    L('Оплатить позже',  'Maksāt vēlāk',       'Pay later'),
  ...
  consent: {
    aria:    L('Настройки cookies', 'Sīkdatņu iestatījumi', 'Cookie preferences'),
    text:    L(
      'Мы используем cookies для аналитики и рекламы, чтобы понимать, что важно гостям. Без них работают только базовые функции сайта.',
      'Mēs izmantojam sīkdatnes analītikai un reklāmai, lai saprastu, kas viesiem ir svarīgi. Bez tām strādā tikai pamata funkcijas.',
      'We use cookies for analytics and advertising to understand what matters to guests. Without them only essential site features work.'
    ),
    accept:  L('Принять',     'Piekrītu',      'Accept'),
    reject:  L('Только нужные','Tikai nepieciešamās','Essential only'),
    privacy: L('Политика конфиденциальности','Privātuma politika','Privacy policy'),
  },
  contact: {
    whatsapp: L('Написать в WhatsApp', 'Rakstīt WhatsApp', 'Chat on WhatsApp'),
  },
  // ▸ Add-on services — deer-park ticket, picnic kit, tent, jacuzzi, sauna
  services: {
    eyebrow:    L('— Услуги парка',     '— Parka pakalpojumi',  '— Park services'),
    titleA:     L('Дополнительные',     'Papildu',              'Add-on'),
    titleAccent:L('услуги',             'pakalpojumi',          'services'),
    titleB:     L('к посещению.',       'apmeklējumam.',        'for your visit.'),
    sub:        L(
      'Билет в олений парк, пикник на территории с оленями, палатка на ночь, джакузи и сауна — забронируй и оплати картой онлайн.',
      'Biļete uz briežu parku, pikniks briežu teritorijā, telts uz nakti, burbuļvanna un pirts — rezervē un samaksā ar karti tiešsaistē.',
      'Deer-park ticket, picnic on the deer grounds, an overnight tent, jacuzzi and sauna — book and pay by card online.'
    ),
    cardOnSite: L(
      '💳 Принимаем карты на месте — VISA / Mastercard. Можно оплатить и наличными.',
      '💳 Pieņemam kartes uz vietas — VISA / Mastercard. Var arī maksāt skaidrā naudā.',
      '💳 Card payments accepted on site — VISA / Mastercard. Cash also welcome.'
    ),
    fields: {
      date:        L('Дата',              'Datums',                'Date'),
      quantity:    L('Количество',        'Daudzums',              'Quantity'),
      persons:     L('человек',           'cilvēki',               'people'),
      hours:       L('часов',             'stundas',               'hours'),
      nights:      L('суток',             'diennaktis',            'nights'),
      sessions:    L('сеанс',             'sesija',                'session'),
      session3h:   L('сеанс · 3 ч',       'sesija · 3 h',          'session · 3 h'),
      hour:        L('час',               'stunda',                'hour'),
      day:         L('сутки',             'diennakts',             'day'),
      pickHours:   L('Сколько часов?',    'Cik stundas?',          'How many hours?'),
      orDay:       L('или сутки',         'vai diennakts',         'or full day'),
      start:       L('Начало',            'Sākums',                'Start'),
      name:        L('Имя',               'Vārds',                 'Name'),
      email:       L('E-mail',            'E-pasts',               'E-mail'),
      phone:       L('Телефон',           'Telefons',              'Phone'),
      notes:       L('Комментарий',       'Komentārs',             'Notes'),
      notesPh:     L('Желания, аллергии, число детей…','Vēlmes, alerģijas, bērnu skaits…','Wishes, allergies, number of children…'),
      total:       L('Итого',             'Kopā',                  'Total'),
      submit:      L('Оплатить картой',   'Maksāt ar karti',       'Pay by card'),
      sending:     L('Отправляем…',       'Nosūtām…',              'Sending…'),
      success:     L('Готово! Перенаправляем на оплату…','Gatavs! Pārvirzām uz maksājumu…','Done! Redirecting to payment…'),
      errGeneric:  L('Не удалось отправить. Попробуйте ещё раз.','Neizdevās nosūtīt. Mēģiniet vēlreiz.','Could not submit. Please try again.'),
      requiredErr: L('Заполните все поля.','Aizpildiet visus laukus.','Please fill all fields.'),
      consentLabel:L(
        'Я согласен(-на) с {terms}, {privacy} и {refund}.',
        'Piekrītu {terms}, {privacy} un {refund}.',
        'I agree to the {terms}, {privacy} and {refund}.'
      ),
    },
    items: {
      deer_ticket: {
        emoji: '🦌',
        title: L('Посещение оленьего парка', 'Briežu parka apmeklējums', 'Deer-park visit'),
        subtitle: L('Безлимит на день', 'Bez limita visu dienu', 'Unlimited all day'),
        price:    L('10 € с человека',     '10 € no cilvēka',       '€10 per person'),
        desc:     L(
          'Один билет — целый день в парке. Заходи сколько угодно раз с 8:00 до 22:00. Корм для оленей — бесплатно на стойке.',
          'Viena biļete — visa diena parkā. Ej iekšā cik reižu vēlies no 8:00 līdz 22:00. Barība briežiem bez maksas pie reģistratūras.',
          'One ticket buys the whole day. Come and go any time 8:00–22:00. Deer food — free at the counter.'
        ),
      },
      picnic_kit: {
        emoji: '🔥',
        title: L('Тент и мангал на территории',  'Telts un grils teritorijā',     'Tent + grill on the grounds'),
        subtitle: L('Пикник среди оленей',       'Pikniks starp briežiem',         'Picnic among the deer'),
        priceHour: L('10 € / час',                '10 € / stunda',                  '€10 / hour'),
        priceDay:  L('50 € / сутки',              '50 € / diennakts',               '€50 / day'),
        desc:      L(
          'Берёшь тент, мангал и площадку посреди парка. Уголь и решётку выдаём бесплатно. Олени подходят сами.',
          'Saņem telti, grilu un vietu parka vidū. Ogles un režģi izsniedzam bez maksas. Brieži pienāk paši.',
          'A canopy, grill and a spot in the middle of the park. Charcoal and grate are on us. Deer come over by themselves.'
        ),
      },
      tent: {
        emoji: '⛺',
        title: L('Палатка на ночь',              'Telts uz nakti',                'Overnight tent'),
        subtitle: L('20 € за сутки',             '20 € par diennakti',            '€20 per day'),
        price:    L('20 € / сутки',              '20 € / diennakts',              '€20 / day'),
        desc:     L(
          'Поставить свою палатку на территории — у озера или у парка. С доступом к санузлу. Огонь — только в мангалах.',
          'Uzstādīt savu telti teritorijā — pie ezera vai pie parka. Ar piekļuvi sanmezglam. Uguns — tikai gridos.',
          'Pitch your own tent on our grounds — by the lake or near the park. Bathroom access included. Fire only in grills.'
        ),
      },
      jacuzzi: {
        emoji: '♨️',
        title: L('Джакузи под открытым небом', 'Burbuļvanna zem klajas debess', 'Open-air jacuzzi'),
        subtitle: L('Сеанс 3 часа',             'Sesija 3 stundas',              '3-hour session'),
        price:    L('70 € / 3 ч',                '70 € / 3 h',                    '€70 / 3 h'),
        desc:     L(
          '39° тёплой воды, тишина леса, звёздное небо. Полотенца включены. Бронируй слот — мы подготовим к приезду.',
          '39° silta ūdens, meža klusums, zvaigžņota debess. Dvieļi iekļauti. Rezervē slotu — sagatavosim ierašanās laikā.',
          '39° warm water, forest silence, starry sky. Towels included. Book a slot — we set it up for your arrival.'
        ),
      },
      sauna: {
        emoji: '🧖',
        title: L('Финская сауна',                'Somu pirts',                    'Finnish sauna'),
        subtitle: L('Сеанс 3 часа',             'Sesija 3 stundas',              '3-hour session'),
        price:    L('30 € / 3 ч',                '30 € / 3 h',                    '€30 / 3 h'),
        desc:     L(
          'Аромат дерева, нагрев камней, рядом — холодная купель в озере. Веники и полотенца — на стойке.',
          'Koka aromāts, akmeņu karstums, blakus — auksta peldvieta ezerā. Slotas un dvieļi pie reģistratūras.',
          'Pine scent, hot stones, a cold dip in the lake right next door. Birch whisks and towels at the counter.'
        ),
      },
    },
    onSiteBanner: {
      title: L('Можно оплатить на месте',       'Var samaksāt uz vietas',         'You can also pay on site'),
      text:  L(
        'Принимаем карты VISA / Mastercard и наличные на ресепшене. Онлайн-оплата нужна только если хочешь зафиксировать слот заранее.',
        'Pieņemam VISA / Mastercard kartes un skaidru naudu reģistratūrā. Tiešsaistes apmaksa nepieciešama tikai, lai iepriekš rezervētu slotu.',
        'We accept VISA / Mastercard and cash at reception. Online payment is only needed if you want to lock a slot in advance.'
      ),
    },
  },
};
